# 更复杂的智能体 creat_agent
# 大模型 model
# 系统提示词 system_propmpt - new
# 工具 tools  用户消息传递参数
# 工具运行时上下文传递参数： context_schema - new
# 记忆管理 checkpoint
# 结构化输出管理 response——format  - new
...
"""
ResponseFormat(punny_response='看来佛罗里达的天气真是"阳光灿烂"啊！这天气简直"晴"不自禁，让人想出去"晒"一下！不过要小心别被"晒"黑了，
毕竟这里的阳光可是"日"理万机！', weather_conditions="It's always sunny in Florida!")
"""
# print(response)
